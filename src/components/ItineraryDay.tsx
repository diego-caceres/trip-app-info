...
export const ItineraryDay: React.FC<ItineraryDayProps> = ({
  ...
  return (
    <div className={`day-card ${isCompact ? "compact" : ""}`}>
      ...
      <div
        className={`day-card-header ${day.country} ${
          isCompact ? "compact" : ""
        }`}
      >
      ...
      {/* Content */}
      <div
        className={`day-card-content ${day.country} ${
          isCompact ? "compact" : ""
        }`}
      >
        {/* Transport */}
        {day.transport && (
          <div className={`content-section ${isCompact ? "compact" : ""}`}>
            <div className={`section-header ${isCompact ? "compact" : ""}`}>
              <div
                className={`section-dot ${day.country} ${
                  isCompact ? "compact" : ""
                }`}
              ></div>
              <span
                className={`section-title ${day.country} ${
                  isCompact ? "compact" : ""
                }`}
              >
                Transporte:
        ...
        <div className={`content-section ${isCompact ? "compact" : ""}`}>
          ...
          <p
            className={`activities-text ${day.country} ${
              isCompact ? "compact" : ""
            }`}
          >
            {day.activities}
        ...
        {day.suggestions.length > 0 && !isCompact && (
          <div className="content-section">
            <div className="section-header">
              ...
              <h4 className={`section-title ${day.country}`}>
                Recomendaciones
              </h4>
            </div>
