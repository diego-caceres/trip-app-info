...
function App() {
  ...
  const getNextViewMode = (): ViewMode => {
    switch (viewMode) {
      ...
      case 'compact': return 'table';
      case 'table': return 'normal';
  ...
  const getViewLabel = (): string => {
    switch (viewMode) {
      case 'normal': return 'Vista Normal';
      case 'compact': return 'Vista Compacta';
      case 'table': return 'Vista Tabla';
  ...
  return (
    <div className="app-container">
          ...
          <div className="header-info">
            <div className="header-info-item">
              ...
              <span style={{ fontWeight: 300 }}>
                {data.tripInfo.departure.city} - {data.tripInfo.departure.date} {data.tripInfo.departure.time}
              </span>
            </div>
            <div className="header-info-item">
              ...
              <span style={{ fontWeight: 300 }}>
                {data.tripInfo.return.city} - {data.tripInfo.return.date} {data.tripInfo.return.time}
              </span>
            </div>
            <div className="header-info-item">
      ...
      {/* Main Content */}
      <main className={`main-content ${viewMode === 'compact' ? 'compact-view' : ''}`}>
        {viewMode === 'table' ? (
          <ItineraryTable days={data.days} />
        ) : (
          /* Itinerary Grid */
          <div className={`itinerary-grid ${viewMode === 'compact' ? 'compact-grid' : ''}`}>
      ...
      <footer className="footer">
        <div className="footer-content">
          <p className="footer-text">
            Itinerario de viaje de <span className="footer-highlight blue">Muri y Dado</span> por Portugal y España •{" "}
            <span className="footer-highlight purple">{data.tripInfo.countries} países</span> •{" "}
            <span className="footer-highlight blue">{data.tripInfo.cities} ciudades</span>
          </p>
